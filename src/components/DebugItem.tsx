...
export function DebugItem({ collection, id }: {
    ...
    const items: CollapseProps['items'] = [
        ...
        },
        {
            ...
            children: <Table rowKey="field" dataSource={fields} pagination={false} size="small">
        ...
        },
        {
            ...
            children: <Table rowKey={(record) => `${record.meta.many_collection},${record.meta.many_field},${record.meta.one_collection},${record.meta.one_field}`}
                dataSource={relations} pagination={false} size="small"
            >
